        ...
        <Stack spacing={12}>
          ...
          <Stack maxW={"md"} spacing={10}>
            ...
            <InputGroup>
              ...
              placeholder="Confirm Password" fontSize={"lg"} bg={"white"} variant="filled" h={16} pl={16} shadow={"md"} rounded={20} />
              <InputRightElement h={16} px={8} color="gray.600" fontSize="20px" onClick={() => setShowPassword2(!showPassword2)}  children={<Icon role={"button"} as= { !showPassword2 ? AiOutlineEyeInvisible : AiOutlineEye}/> } />
            </InputGroup>
          </Stack>
